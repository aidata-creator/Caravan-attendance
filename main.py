...
if uploaded_file is not None:
    ...
    with col2:
        ...
        try:
            # Send image to the Gemini 3 Flash vision pipeline
            ...
            status_text.error("❌ Processing failed: The returned AI output wasn't cleanly structured. Please try upload again.")
        except Exception as e:
